...
<head>
    ...
    <link href="<c:url value="/resources/theme1/css/main2.css" />" type="text/css" rel="stylesheet">
...
<section class="section-advertisement">
    ...
    <div id="wrapper">
    <form action="/add_tableTennisAdv" method="get">
        <button type="submit" class="btn btn-primary btn-adv">Add table tennis advertisement</button>
    </form>
    </div>
